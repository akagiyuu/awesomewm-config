...
local widget_icon_dir = config_dir .. 'widget/notification_center/icons/'

local empty_notifbox = require('widget.notification_center.build-notifbox.empty-notifbox')
local notifbox_scroller = require('widget.notification_center.build-notifbox.notifbox-scroller')
...
local notifbox_add = function(n, notif_icon, notifbox_color)
	...
	local notifbox_box = require('widget.notification_center.build-notifbox.notifbox-builder')
